...
const Moviedetails = ({movie}) => {
  return (
    ...
    <div className="px-3">
      ...
      <h1 className="font-bold text-white text-xl my-2">{movie.title}</h1>
      <p className="text-white text-sm mt-4">{movie.overview}</p>
...
export async function getStaticProps(context) {
    ...
    const res = await axios(`https://api.themoviedb.org/3/movie/${id}?api_key=3c26fa10758e578bf1c04582001abc90&language=en-US&page=1`);
